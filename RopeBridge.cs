...
public class RopeBridge : MonoBehaviour
{
    ...
    private void ApplyConstraint()
    {
        ...
        firstSegment.posNow = this.StartPoint.transform.position;
        this.ropeSegments[0] = firstSegment;

        //Constrant to Second Point 
        RopeSegment endSegment = this.ropeSegments[this.ropeSegments.Count - 1];
        endSegment.posNow = this.EndPoint.transform.position;
    ...
    private void DrawRope()
    {
        ...
        Vector3[] ropePositions = new Vector3[this.segmentLength+1];//jjo
        for (int i = 0; i < this.segmentLength; i++)
        {
            ropePositions[i] = this.ropeSegments[i].posNow;
        }
        ropePositions[this.segmentLength] = EndPoint.transform.position;//jjo
